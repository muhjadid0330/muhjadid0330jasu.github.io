...
<?php 
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 JASU Academy  By Lo Group </a>.</strong> All rights reserved.
  </footer>
   <?php
              $id_user=$this->session->userdata('id_user');
              $q=$this->db->query("SELECT * FROM tbl_user WHERE id_user='$id_user'");
 ...
 <div class="modal fade" id="ModalEdit<?php echo $id_user;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'user/siswa/update_mhs'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                  ...
                                  <input type="number" name="nik" class="form-control" value="<?php echo  $c['nik'];?>" id="inputUserName" placeholder="Nik" required>
                                </div>
                            </div>
                            <div class="form-group">
