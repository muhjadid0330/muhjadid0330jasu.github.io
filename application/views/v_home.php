  ...
  <header id="header">
    <div class="container-fluid">
      <div id="logo" class="pull-left">
      	<a class="h5co"><img src="assets/logojasu.png" width="80px" height="80px"> </a>
  
    <h1>PORTAL JASU</h1>
     <h3>BY JASU ACADEMY</h3>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="<?php echo base_url().'theme/images/ua.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Portal JASU</h2>
		   					<h3><p>Learning & Sharing</p></h3>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'theme/images/berita.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
               <h2>Berita</h2>
               <h3><p>Portal berita terkini</p></h3>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'theme/images/artikel.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Artikel</h2>
                <h3><p>Kumpulan artikel</p></h3>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'theme/images/investasi.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
               <h2>Investasi</h2>
               <h3><p>Belajar investasi</p></h3>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'theme/images/keuangan.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
               <h2>Keuangan</h2>
               <h3><p>Manajemen keuangan</p></h3>
...
<!--            
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>JASU ACADEMY</strong>. All Rights Reserved
      </div>
